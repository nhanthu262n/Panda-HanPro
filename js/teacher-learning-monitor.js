...
(() => {
  ...
  const labels={phonetics_core:'Ngữ âm',listening:'Nghe',speaking:'Nói',reading_writing:'Đọc / Viết','vocab-intro':'Học từ vựng',quest:'Pinyin Tone Quest',remediation:'Luyện sửa lỗi',teacherDraft:'Bài chờ giáo viên chấm',memory_learning:'Học lại từ',recommendation_choice:'Lựa chọn bài luyện',srs:'Ôn ghi nhớ'};
