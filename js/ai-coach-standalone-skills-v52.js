(() => {
  ...
  const state = {
    mode: null, mission: null, items: [], index: 0, answers: [], scores: [], speakingItems: [], itemStartedAt:0,
...
.ptcs-teacher-report{margin-top:14px;border:1px solid #dbeafe;border-radius:16px;background:#fbfdff;overflow:hidden;text-align:left}.ptcs-teacher-head{display:flex;justify-content:space-between;gap:10px;padding:11px 13px;background:#eef5ff;border-bottom:1px solid #dbeafe}.ptcs-teacher-head b{color:#102a43}.ptcs-teacher-head span{color:#1d4ed8;font-size:11px;font-weight:900}.ptcs-teacher-body{padding:12px 13px}.ptcs-teacher-section{margin-top:9px;padding-top:9px;border-top:1px dashed #d9e3ef}.ptcs-teacher-section:first-child{margin-top:0;padding-top:0;border-top:0}.ptcs-teacher-section h4{margin:0 0 4px;color:#102a43;font-size:12px}.ptcs-teacher-section p,.ptcs-teacher-list{color:#526173;font-size:12px;line-height:1.55}.ptcs-teacher-list{margin:4px 0 0;padding-left:18px}.ptcs-teacher-summary{margin-top:14px;padding:13px;border:1px solid #dbeafe;border-radius:14px;background:#f8fbff;text-align:left}.ptcs-teacher-summary h3{margin:0 0 6px;color:#102a43;font-size:14px}.ptcs-teacher-summary p{margin:4px 0;color:#526173;font-size:12px;line-height:1.55}
...
`;
  ...
  function renderListening(){
    state.itemStartedAt=Date.now();const host=document.getElementById("ptCoachSkillContent"), item=state.items[state.index];if(!host||!item)return;
  ...
  function answerListening(btn,item){
    ...
    window.PandaHanAdaptiveRetryV1?.wrapNext("ptcsListenNext",state.mission,item.word?.char,correct,9);
  }
